...
export const Hero = () => {
  return (
    ...
    <div className=" transition-transform flex flex-col items-center  -mt-12">
      <h1 className="text-center text-[5vw] xl:text-[4vw] 2xl:text-[3vw] 2xl:pl-8 2xl:pr-8 leading-relaxed tracking-tighter text-white ">
      ...
      <p className="text-center mt-16 pl-8 pr-8 text-white xl:text-[1.2vw] xl:w-4/6">
      ...
      <Link href="/mood-picker" className="overflow-hidden flex justify-center hover:scale-105 duration-300 items-center mt-16 font-questrial sm:w-48 sm:h-16 w-32  h-12 bg-red-700 text-white border-none rounded-md text-xl font-bold cursor-pointer relative z-10 group">
        Start Now
